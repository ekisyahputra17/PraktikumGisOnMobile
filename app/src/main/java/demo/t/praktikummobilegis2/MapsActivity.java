package demo.t.praktikummobilegis2;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady (GoogleMap googleMap) {
        ...
        LatLng untadbaru = new LatLng(-0.858365, 119.883981);
        ...
        mMap.addMarker(new MarkerOptions().position(untadbaru).title("Marker in RS Undata Baru")
